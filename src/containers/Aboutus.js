...
const Aboutus = () => {
  return (
    <section className='bg-gray-100 flex flex-col justify-center items-center mt-9 p-5'>
      <div className='w-3/5 flex justify-center items-center mobile:flex-col desktop:flex-row'>
        <div>
          <h1 className='text-5xl'>About Tail your Wind</h1>
